...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 81e34708-a8e3-47d1-9c1e-6d9263c69b04
```

> `81e34708-a8e3-47d1-9c1e-6d9263c69b04` is the password of the certificate, you can change it to any password you want.
